...
export default function ScheduleSection() {
  ...
  return (
    <LandingSectionCard
      sectionId="schedule"
      sectionClassName="sec-schedule"
      tagText="FILE: SCHEDULE"
      title="CHOOSE YOUR TRACK"
      subtitle="Select the induction schedule corresponding to your programme and explore the events planned for your orientation."
    >
